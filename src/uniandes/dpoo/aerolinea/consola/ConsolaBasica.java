...
/**
 * Esta es una clase abstracta que implementa métodos útiles para todas las
 * consolas de la aplicación.
 */
	...
	protected String pedirOpcionAlUsuario(Collection<? extends Object> coleccionOpciones) {
		...
		try {
			...
			if (opcionSeleccionada > 0 && opcionSeleccionada <= opciones.length)
				...
				System.out
						.println("Esa no es una opción válida. Digite solamente números entre 1 y " + opciones.length);
