...
/**
 * Esta excepción se usa para indicar que se encontraron dos clientes con el
 * mismo identificador, lo cual nunca debería ocurrir.
 */
...
public class ClienteRepetidoException extends InformacionInconsistenteException {
	...
	public String getMessage() {
		return "Cliente repetido: ya existe un cliente de tipo " + tipoCliente + "  con el identificador "
				+ this.identificador;
	}
